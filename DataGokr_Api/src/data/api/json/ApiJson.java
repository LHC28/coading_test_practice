...
public class ApiJson {
	...
	public static void main(String[] args) {
		...
		// 버퍼 장점 : 버퍼를 이용하기 대문에 입출력 관련 처리 작업을ㅇ 매우 빠르게 할 수 있다.
		...
		try {
			...
			String urlStr = "http://apis.data.go.kr/B552061/jaywalking/getRestJaywalking?serviceKey=xyh7G83G3D4AgX8sLtgxDST1Brqg4otE9ZW6ekhmAOTykr7kJOR39CPGpUn%2F%2FnoP%2FMtl4XEoMnR7yGUzuPvY2Q%3D%3D&searchYearCd=2015&siDo=11&guGun=320&type=xml&numOfRows=10&pageNo=1";
			...
			// BuffredReader는 InputStreamReader의 객체를 입력값으로 사용
